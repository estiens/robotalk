...
RSpec.configure do |config|
  ...
  # Use transactional fixtures for all specs (much faster and avoids database locks)
  ...
  # Run ActiveJob jobs inline during tests
  ...
  def record_new_cassette(cassette_name, &block)
    VCR.use_cassette(cassette_name, record: :new_episodes, &block)
  end

  # Helper method to force re-recording of cassettes
